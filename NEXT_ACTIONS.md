...
7. Owner-created public GitHub repository verified. Await explicit approval to publish
   the reviewed source payload following automatic review rejection. Then push and
   validate remote Windows/Linux synthetic CI. Game data and private reports excluded.
